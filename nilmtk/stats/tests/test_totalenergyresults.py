...
class TestEnergyResults(unittest.TestCase):
    ...
    def test_combined(self):
        ...
        self.assertEqual(er['apparent'], 80)#.combined()['apparent'], 80)
        self.assertEqual(er['reactive'], 50)#.combined()['reactive'], 50)
        self.assertEqual(er['active'], 30)#.combined()['active'], 30)
